...
export const categories = [
  ...
  { id: "c4", name: "Festive Collection", image: img(pick(6), 600, 600), count: 6, status: "Active" },
  { id: "c5", name: "Coming Soon — Saree", image: img(pick(8), 600, 600), count: 0, status: "Coming Soon" },
];
...
export const districts = [
  ...
  "Cumilla", "Narayanganj", "Gazipur", "Cox's Bazar", "Jashore", "Bogura", "Dinajpur",
];
...
export const orders: Order[] = [
  { id: "NGR-1042", customer: "Tasnim Rahman", phone: "01711-223344", district: "Dhaka", date: "2025-05-26", items: 2, total: 5380, payment: "bKash", paymentStatus: "Verification Needed", status: "Pending" },
  { id: "NGR-1041", customer: "Nusrat Jahan", phone: "01812-556677", district: "Chattogram", date: "2025-05-26", items: 1, total: 3290, payment: "COD", paymentStatus: "COD", status: "Confirmed", courier: "Steadfast", trackingId: "SF-88291" },
  { id: "NGR-1040", customer: "Mehnaz Karim", phone: "01911-998877", district: "Sylhet", date: "2025-05-25", items: 3, total: 8470, payment: "Nagad", paymentStatus: "Paid", status: "Shipped", courier: "Pathao", trackingId: "PT-44120" },
  { id: "NGR-1039", customer: "Rabeya Sultana", phone: "01711-334455", district: "Dhaka", date: "2025-05-25", items: 1, total: 2690, payment: "bKash", paymentStatus: "Paid", status: "Delivered", courier: "Steadfast", trackingId: "SF-88200" },
  { id: "NGR-1038", customer: "Sumaiya Akter", phone: "01612-778899", district: "Khulna", date: "2025-05-24", items: 2, total: 5180, payment: "COD", paymentStatus: "COD", status: "Processing" },
  { id: "NGR-1037", customer: "Farzana Hoque", phone: "01511-112233", district: "Rajshahi", date: "2025-05-24", items: 1, total: 3490, payment: "Rocket", paymentStatus: "Pending", status: "Pending" },
  { id: "NGR-1036", customer: "Anika Tabassum", phone: "01811-445566", district: "Dhaka", date: "2025-05-23", items: 4, total: 11280, payment: "Card", paymentStatus: "Paid", status: "Delivered", courier: "RedX", trackingId: "RX-22019" },
  { id: "NGR-1035", customer: "Sadia Islam", phone: "01711-667788", district: "Cumilla", date: "2025-05-23", items: 1, total: 1690, payment: "COD", paymentStatus: "Failed", status: "Cancelled" },
];
...
export const customers: Customer[] = [
  { id: "u1", name: "Tasnim Rahman", phone: "01711-223344", email: "tasnim@example.com", totalOrders: 7, totalSpend: 28400, lastOrder: "2025-05-26", status: "Active" },
  { id: "u2", name: "Nusrat Jahan", phone: "01812-556677", email: "nusrat@example.com", totalOrders: 4, totalSpend: 14290, lastOrder: "2025-05-26", status: "Active" },
  { id: "u3", name: "Mehnaz Karim", phone: "01911-998877", email: "mehnaz@example.com", totalOrders: 12, totalSpend: 46180, lastOrder: "2025-05-25", status: "Active" },
  { id: "u4", name: "Sadia Islam", phone: "01711-667788", email: "sadia@example.com", totalOrders: 1, totalSpend: 1690, lastOrder: "2025-05-23", status: "Flagged" },
  { id: "u5", name: "Anika Tabassum", phone: "01811-445566", email: "anika@example.com", totalOrders: 9, totalSpend: 31900, lastOrder: "2025-05-23", status: "Active" },
];

export const coupons = [
  { code: "NONGOR10", type: "Percentage", value: 10, minOrder: 2000, expiry: "2025-12-31", uses: 142, active: true },
  { code: "FESTIVE500", type: "Flat", value: 500, minOrder: 3000, expiry: "2025-08-31", uses: 56, active: true },
  { code: "FREESHIP", type: "Free Delivery", value: 0, minOrder: 2500, expiry: "2025-07-15", uses: 89, active: true },
  { code: "WELCOME15", type: "Percentage", value: 15, minOrder: 1500, expiry: "2025-06-30", uses: 312, active: false },
];

export const reviews = [
  { id: "r1", product: "Maroon Nakshi Handmade Kurti", customer: "Tasnim R.", rating: 5, text: "The stitching detail is gorgeous, fabric feels premium.", status: "Approved" },
  { id: "r2", product: "Golden Thread Festive Kurti", customer: "Nusrat J.", rating: 5, text: "Wore it for Eid and got so many compliments.", status: "Approved" },
  { id: "r3", product: "Ivory Floral Cotton Kurti", customer: "Sadia I.", rating: 3, text: "Nice but size ran a bit small.", status: "Pending" },
  { id: "r4", product: "Wine Red Handloom Kurti", customer: "Mehnaz K.", rating: 5, text: "Handloom quality is exceptional.", status: "Approved" },
];
