  ...
  return (
    <div className="bg-cream/30">
      <PolicyHeader
        ...
        tagline="Your trust is the thread that holds us together."
      />
      <article className="container-narrow py-12 md:py-16">
        <div className="mx-auto max-w-3xl bg-ivory rounded-3xl shadow-soft border border-hairline p-7 md:p-12 prose-policy">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            At Nongor (নোঙর), we treat your personal information with the same care we put into
            every hand-stitched kurti. This policy explains what we collect, why we collect it, and
          ...
          <Section title="1. Information we collect">
            <ul>
              <li>
                <b>Account details:</b> your name, email, and phone number.
              </li>
              <li>
                <b>Order &amp; delivery details:</b> shipping address, district, postal code, and
                order history.
              </li>
              <li>
                <b>Payment information:</b> payment method, transaction ID, and last four digits of
                cards (we never store full card numbers).
              </li>
              <li>
                <b>Technical data:</b> device type, browser, IP address, and basic analytics to
                improve the site.
              </li>
              <li>
                <b>Communication:</b> messages you send through chat, email, or our contact form.
              </li>
            </ul>
          </Section>
          ...
          <Section title="2. How we use your information">
            <ul>
              ...
              <li>
                To verify payments made through bKash, Nagad, Rocket, cards, or COD confirmation.
              </li>
              <li>
                To send order updates, delivery notifications, and important account messages.
              </li>
          ...
          <Section title="3. Cookies &amp; analytics">
            <p>
              ...
              cart. Basic, anonymised analytics help us understand which products our customers love
              most. You may clear cookies from your browser at any time.
            </p>
          </Section>
          ...
          <Section title="5. Data security">
            <p>
              Your password is hashed and never stored in plain text. Sessions are encrypted. We
              restrict internal access to the minimum number of team members required to serve you.
            </p>
          </Section>
          ...
          <Section title="8. Contact us">
            <p>
              ...
              or visit our{" "}
              <Link to="/about" className="text-maroon underline">
                contact page
              </Link>
              .
            </p>
...
export function PolicyHeader({ title, tagline }: { title: string; tagline: string }) {
  return (
    <header className="relative overflow-hidden bg-gradient-to-b from-cream to-ivory border-b border-hairline">
      <div
        className="absolute inset-0 pattern-nakshi opacity-[0.06] pointer-events-none"
        aria-hidden
      />
      <div className="container-narrow py-10 md:py-14 relative">
        ...
        <div className="mt-4 flex items-start gap-3">
          <div className="h-10 w-10 rounded-full bg-maroon/10 grid place-items-center">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mt-8">
      ...
      <div className="mt-2 text-sm leading-relaxed text-foreground/80 space-y-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1.5 [&_b]:text-foreground">
        {children}
      </div>
    </section>
  );
